...
public class TileGeneration : MonoBehaviour
{
    ...
    //Genera el ruido que se usara como mapa
    [SerializeField]
    NoiseMapGeneration noiseMapGeneration;

    //Objeto sobre el que aplicar las texturas
    [SerializeField]
    ...
    //Tamaño sobre el que se aplicara la capa de ruido
    [SerializeField]
    ...
    //Diferenciacion proporcional de alturas
    [SerializeField]
    private float heightMultiplier;

    //Gestiona la transicion entre alturas
    [SerializeField]

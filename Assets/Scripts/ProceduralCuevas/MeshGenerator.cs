                    ...
                    if (sqrDst <= sqrViewDistance) {
                        ...
                        if (IsVisibleFrom (bounds, Camera.main)) {
                            if (recycleableChunks.Count > 0) {
                                ...
                                chunks.Add (chunk);
                                UpdateChunkMesh (chunk);
                                /*Vector3Int coord2 = new Vector3Int (x, y+200, z) + viewerCoord;
                                Chunk chunk2 = CreateChunk (coord2);
                                chunk2.coord = coord2;
                                chunk2.SetUp (mat, generateColliders);
                                existingChunks.Add (coord2, chunk2);
                                chunks.Add (chunk2);
                                UpdateChunkMesh (chunk2);*/
                            }
                        }
                    }
